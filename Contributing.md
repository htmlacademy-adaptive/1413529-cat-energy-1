...
```
git remote add academy git@github.com:htmlacademy-adaptive/1413529-cat-energy-1.git
```
...
Посмотрите [коллекцию часто задаваемых вопросов по Git]тзч.(http://firstaidgit.ru/)
